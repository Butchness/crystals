...
public partial class Game : Node
{
    ...
    public override async void _Ready()
    {
        try
        {
            GD.Print("[Game] Ready start: wiring services. (startup-debug-v3)");
            ...
            GD.Print("[Game] Initializing world state.");
            if (!LoadSaveOnStartup)
            {
                GD.Print("[Game] LoadSaveOnStartup=false; skipping save load and using default WorldState.");
